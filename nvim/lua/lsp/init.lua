  ...
  for _, server in pairs(servers) do
    ...
    if server == "typescript" then
      config.on_attach = function(client, bufnr)
        ...
        vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>io", ":TSLspOrganize<CR>", {silent = true})
        vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>fc", ":TSLspFixCurrent<CR>", {silent = true})
        vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>fr", ":TSLspRenameFile<CR>", {silent = true})
